...
SCRIPT_VERSION = "36-align-frozen-modules-to-mofa-v1"
...
def matched_random_vectors(
    ...
    metadata_index = metadata.set_index("human_gene_symbol").reindex(genes)
...
def main() -> None:
    ...
    for model_row in model_index.itertuples(index=False):
        ...
        metadata = (
            metadata.set_index("human_gene_symbol")
